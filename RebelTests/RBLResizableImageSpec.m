...
it(@"should use @1x asset", ^{
	...
	[testImage drawInRect:(CGRect){ .origin = CGPointZero, .size = targetSize } fromRect:NSZeroRect operation:NSCompositeCopy fraction:1. respectFlipped:YES hints:nil];
